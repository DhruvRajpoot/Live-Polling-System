...
const Button = ({
  ...
  const baseClasses =
    "w-80 h-15 rounded-full text-white text-lg font-semibold leading-6 font-sora transition-all duration-200 hover:opacity-90 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed";
